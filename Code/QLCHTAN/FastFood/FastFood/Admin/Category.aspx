                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-4 col-lg-4">
                                                <h4 class="sub-title">Dòng sản phẩm</h4>
                                                <div>
                                                    <div class="form-group">
                                                        <label>Tên dòng sản phẩm</label>
                                                        <div>
                                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                                placeholder="Nhập tên dòng sản phẩm" required></asp:TextBox>
                                                            <asp:HiddenField ID="hdnId" runat="server" Value="0" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Hình dòng sản phẩm</label>
                                                        <div>
                                                    ...
                                                    <div class="pb-5">
                                                        <div>
                                                            ...
                                                            &nbsp
                                                        <asp:Button ID="btnClear" runat="server" Text="Làm sạch" CssClass="btn btn-primary"
                                            ...
                                            <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                                <h4 class="sub-title">Danh sách dòng sản phẩm</h4>
